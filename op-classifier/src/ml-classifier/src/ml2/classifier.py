...
if __name__ == '__main__':
	...
	if(training_ds_file is not None):
	...
	if(training_file_provided and model_file is None): # Only the training file is provided. But no model file to save.
		cl = Classifier(trainer,training_data_set,test_data_set)
	elif(training_file_provided and model_file is not None): #  the training file and model file, both provided. Model file will be used for output (save).
